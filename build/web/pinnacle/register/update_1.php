...
/*
                day = Integer.parseInt(result.getString("day"));
                month = Integer.parseInt(result.getString("month"));
                year = Integer.parseInt(result.getString("year"));
  */
...
<form method = post action = "register/checkuser.jsp">
    <table class = "boundary" width="100%">
        <tr >
            <td colspan = 4 align = center> <h1 class = "test">Update Form</h1> </td>
        </tr>
        <tr align = right>
            <td>Name :</td>
